...
public class Scenario4 {
    ...
    public void Scenario_1() throws IOException, InterruptedException {
        ...
        String path_to_test_excel = (path_to_the_program + "\\" + path_to_the_test + "\\" + "test.xlsx333").replace("\\", "\\\\");
        ...
        String jsonInputString = "{"
                ...
                + "\"path_excel\":\"" + path_to_test_excel + "\","
                + "\"excel_sheet\":\"Sheet1\",\"coordinates_of_the_selected_table\":\"A1:C6\","
