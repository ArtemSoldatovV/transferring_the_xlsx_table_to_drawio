...
//    String id = generation_id();
    ...
    public static String table_root(String id, int item_number, int y, int x, int cells_in_height, int cells_in_width, int height, int width){
        //строка
    ...
    public static String table_string(String id, int item_number, int cells_in_height, int height, int width){
        //строка
    ...
    public static String table_cell(String id, int item_number, String cell_value, int height, int width){
        //ячейка
