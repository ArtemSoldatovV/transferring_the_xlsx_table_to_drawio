...
//есть ошибка в логике
    public static String create(ArrayList<String> the_value_of_all_cells , int y, int x, int cells_in_height, int cells_in_width, int height, int width)
    {
        ...
        while (how_many_cells_are_made < total_number_of_cells){
            ...
            if(number_of_width == 0 |
                ...
                exit += table_string( id, item_number,  cells_in_height,  height,  width, number_of_width);
                item_number_of_width = item_number;
                number_of_width += 1;
            }
            else {
                exit += table_cell( id,  item_number,  the_value_of_all_cells.get(how_many_cells_are_made),  height,  width, account_cell, item_number_of_width);
    ...
    private static String table_string(String id, int item_number, int cells_in_height, int height, int width, int number_of_width){
        //строка
        String indent1 = "        ";
        String indent2 = "          ";
    ...
    private static String table_cell(String id, int item_number, String cell_value, int height, int width, int account_cell, int number_of_width){
        //ячейка
        String indent1 = "        ";
        String indent2 = "          ";
        String indent3 = "            ";
